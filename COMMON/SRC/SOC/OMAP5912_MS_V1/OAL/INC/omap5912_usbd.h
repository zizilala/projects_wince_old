...
//------------------------------------------------------------------------------
//
//  File:  omap5912_usbd.h
//
#ifndef __OMAP5912_USBD_H
#define __OMAP5912_USBD_H
...
typedef volatile struct {
    ...
    UINT32 EP_RX[15];               // 0084 - Receive endpoint 1..15 config
    UINT32 RESERVED_00C0;           // 00C0
    UINT32 EP_TX[15];               // 00C4 - Transmit endpoint 1..15 config
} OMAP5912_USBD_REGS;
...
#define USBD_DMA_IRQ_EN_TX2_DONE    (1 << 10)
#define USBD_DMA_IRQ_EN_RX2_CNT     (1 << 9)
#define USBD_DMA_IRQ_EN_RX2_EOT     (1 << 8)
#define USBD_DMA_IRQ_EN_TX1_DONE    (1 << 6)
#define USBD_DMA_IRQ_EN_RX1_CNT     (1 << 5)
#define USBD_DMA_IRQ_EN_RX1_EOT     (1 << 4)
#define USBD_DMA_IRQ_EN_TX0_DONE    (1 << 2)
#define USBD_DMA_IRQ_EN_RX0_CNT     (1 << 1)
#define USBD_DMA_IRQ_EN_RX0_EOT     (1 << 0)

#define USBD_DMA_STAT_RX_SB         (1 << 12)       // DMA Rx Single Byte (non-ISO)
#define USBD_DMA_STAT_RX_IT_SRC     0x0F00          // DMA Rx Interrupt Source
#define USBD_DMA_STAT_TX_IT_SRC     0x000F          // DMA Tx Interrupt Source
...
#define USBD_DMASTAT_RX_SB          (1 << 12)       // Received single byte
...
#define USBD_TXDMA_EOT              (1 << 15)
#define USBD_TXDMA_START            (1 << 14)

#define USBD_RXDMA_STOP             (1 << 15)
