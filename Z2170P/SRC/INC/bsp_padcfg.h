...
/*#define I2C3_PADS \
    PAD_ENTRY(I2C3_SCL, INPUT_ENABLED | PULL_RESISTOR_DISABLED | GPIO_DIR_OUTPUT | MUXMODE(4))   \
    PAD_ENTRY(I2C3_SDA, INPUT_ENABLED | PULL_RESISTOR_DISABLED | GPIO_DIR_OUTPUT | MUXMODE(4)) */
