...
void OALGPIOSetDefaultValues()
{
    ...
    // configure new EVM2 control signals
    // unmute audio AUDIO_MUTE (T2_GPIO6 = 0)
    GPIOClrBit(hGPIO,AUDIO_MUTE_GPIO);            
...
DWORD OEMEnumExtensionDRAM(PMEMORY_SECTION pMemSections,DWORD cMemSections)
{
    ...
    // If DSP 720p region is not used for the DSP, give it to the OS
