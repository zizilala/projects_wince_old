...
#define IMAGE_WINCE_CODE_SIZE			0x00FFE000   // 

#define IMAGE_WINCE_EXT_CA			0x81001000  // 
#define IMAGE_WINCE_EXT_SIZE			0x07FFF000  // 
#define IMAGE_WINCE_RAM_CA			0x81001000  // 
#define IMAGE_WINCE_RAM_SIZE			0x07FFF000  // 
#else
