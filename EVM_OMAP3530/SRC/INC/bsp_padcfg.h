...
{       \
    ...
    PAD_ENTRY(HDQ_SIO             ,INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(0))     \
...
#define DSS_PADS  \
	...
	PAD_ENTRY(MCBSP4_CLKX,      INPUT_DISABLED | MUXMODE(4)) /* GPIO 153 */	\
	PAD_ENTRY(MCBSP4_DR,        INPUT_DISABLED | MUXMODE(4)) /* GPIO 153 */	\
    PAD_ENTRY(MCBSP4_DX,        INPUT_DISABLED | MUXMODE(4)) /* GPIO 154 */ \
    PAD_ENTRY(MCBSP4_FSX,       INPUT_DISABLED | MUXMODE(4)) /* GPIO 155 */ \
	WKUP_PAD_ENTRY(SYS_BOOT1,	INPUT_DISABLED | MUXMODE(4)) /* GPIO 3   */	
...
#define DSS_PADS_37XX  \
    ...
    PAD_ENTRY(MCBSP4_CLKX,      INPUT_DISABLED | MUXMODE(4)) /* GPIO 152 */ \
    PAD_ENTRY(MCBSP4_DR,        INPUT_DISABLED | MUXMODE(4)) /* GPIO 153 */ \
    PAD_ENTRY(MCBSP4_DX,        INPUT_DISABLED | MUXMODE(4)) /* GPIO 154 */ \
    PAD_ENTRY(MCBSP4_FSX,       INPUT_DISABLED | MUXMODE(4)) /* GPIO 155 */
...
#define MMC1_PADS   \
    ...
    //PAD_ENTRY(MMC1_DAT4, INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(0))                                            \
    //PAD_ENTRY(MMC1_DAT5, INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(0))                                            \
    //PAD_ENTRY(MMC1_DAT6, INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(0))                                            \
    //PAD_ENTRY(MMC1_DAT7, INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(0))                                            
...
#define GPIO_PADS   \
    WKUP_PAD_ENTRY(SYS_BOOT5,   INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4))										\
	WKUP_PAD_ENTRY(SYS_BOOT0,	INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 2  : LCD Left/Right*/			\
	PAD_ENTRY(MCSPI1_CS1,       INPUT_ENABLED | MUXMODE(4))							  /* GPIO 175  : TOUCH penIRQ*/			\
    PAD_ENTRY(MCSPI1_CS2,       INPUT_ENABLED | MUXMODE(4))							  /* GPIO 176  : LAN irq*/				\
    PAD_ENTRY(SYS_NIRQ,         INPUT_ENABLED | MUXMODE(4))							  /* GPIO 0  : TPS659XX irq*/			\
	PAD_ENTRY(GPMC_WAIT2,       INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 64  : TPS659XX MSECURE pin*/	\
    PAD_ENTRY(GPMC_nBE1,		INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 61 : USB2_ROUTE_SELECT_GPIO */ \
    PAD_ENTRY(MCBSP1_FSR,		INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 157 : VIDEO_CAPTURE_SELECT2 */ \
