...
LPCWSTR g_oalIoCtlPlatformType = L"AM35x";
...
LPCWSTR g_oalIoCtlPlatformName = L"AM35x";
...
LPCWSTR g_oalIoCtlProcessorName   = L"AM35x";
...
)
{
    ...
    // JH : why  should we call init RTC a second time
    // // call RTC init
