...
{       \
    ...
    PAD_ENTRY(CSI2_DX1			  ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CSI2_DY1			  ,RELEASED_PAD_DEFAULT_CONFIG)     \
...
/* 20131007-Ray - for battery*/
#define I2C3_PADS \
    PAD_ENTRY(I2C3_SCL, INPUT_ENABLED | PULL_RESISTOR_DISABLED | PULLUP_RESISTOR | MUXMODE(0))   \
    PAD_ENTRY(I2C3_SDA, INPUT_ENABLED | PULL_RESISTOR_DISABLED | PULLUP_RESISTOR | MUXMODE(0))

/* 20131021-Ray - for I2C3 GPIO*/
/*#define I2C3_PADS \
    PAD_ENTRY(I2C3_SCL, INPUT_ENABLED | PULL_RESISTOR_DISABLED | PULLUP_RESISTOR | GPIO_DIR_OUTPUT | MUXMODE(4))   \
    PAD_ENTRY(I2C3_SDA, INPUT_ENABLED | PULL_RESISTOR_DISABLED | PULLUP_RESISTOR | GPIO_DIR_OUTPUT | MUXMODE(4)) */

#define I2C4_PADS   \
    WKUP_PAD_ENTRY(I2C4_SCL, INPUT_ENABLED | PULL_RESISTOR_DISABLED | MUXMODE(0))   \
    WKUP_PAD_ENTRY(I2C4_SDA, INPUT_ENABLED | PULL_RESISTOR_DISABLED | MUXMODE(0))   
   
/* 20130924-Ray - for LCM panel */
#define MCSPI1_PADS \
    PAD_ENTRY(MCSPI1_CS0, INPUT_DISABLED | PULL_RESISTOR_DISABLED | GPIO_DIR_OUTPUT |MUXMODE(4)) \
    PAD_ENTRY(MCSPI1_SOMI,INPUT_ENABLED | PULL_RESISTOR_DISABLED | GPIO_DIR_INPUT |MUXMODE(4)) \
    PAD_ENTRY(MCSPI1_SIMO,INPUT_DISABLED | PULL_RESISTOR_DISABLED |GPIO_DIR_OUTPUT |MUXMODE(4)) \
    PAD_ENTRY(MCSPI1_CLK, INPUT_ENABLED | PULL_RESISTOR_DISABLED | GPIO_DIR_OUTPUT |MUXMODE(4)) \
    //PAD_ENTRY(SPI_CLK_PIN, INPUT_ENABLED | PULL_RESISTOR_DISABLED | GPIO_DIR_OUTPUT |MUXMODE(4))
...
#define GPIO_PADS_37XX \
	...
	PAD_ENTRY(CSI2_DX1,	INPUT_ENABLED | MUXMODE(4)) /* GPIO 114 : SD1_IRQ */ \
	PAD_ENTRY(CSI2_DY1,	INPUT_ENABLED | MUXMODE(4)) /* GPIO 115 : SD3_IRQ */ \
