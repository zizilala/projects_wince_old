...
//  File:  omap2420_otg.h
//
#ifndef __OMAP2420_OTG_H
#define __OMAP2420_OTG_H
...
#define OTG_SYSCON_2_OTG_EN         (1 << 31)
#define OTG_SYSCON_2_ENABLE         (1 << 31)
#define OTG_SYSCON_2_SYNCHRO        (1 << 30)
#define OTG_SYSCON_2_OTG_MST16      (1 << 29)
#define OTG_SYSCON_2_MST16          (1 << 29)
#define OTG_SYSCON_2_SRP_GPDATA     (1 << 28)
#define OTG_SYSCON_2_SRP_GPDVBUS    (1 << 27)

#define OTG_SYSCON_2_SRP_DPW        (1 << 14)
#define OTG_SYSCON_2_SRP_DATA       (1 << 13)
#define OTG_SYSCON_2_SRP_VBUS       (1 << 12)
#define OTG_SYSCON_2_OTG_PADEN      (1 << 10)
#define OTG_SYSCON_2_HMC_PADEN      (1 << 9)
#define OTG_SYSCON_2_UHOST_EN       (1 << 8)
#define OTG_SYSCON_2_HMC_TLLSPEED   (1 << 7)
#define OTG_SYSCON_2_HMC_TLLATTACH  (1 << 6)
...
#define OTG_CTRL_OTG_BUSDROP        (1 << 7)
#define OTG_CTRL_BUSDROP            (1 << 7)
#define OTG_CTRL_OTG_PD             (1 << 5)
#define OTG_CTRL_PD                 (1 << 5)
#define OTG_CTRL_OTG_PU             (1 << 4)
#define OTG_CTRL_PU                 (1 << 4)
#define OTG_CTRL_OTG_DRV_VBUS       (1 << 3)
#define OTG_CTRL_DRV_VBUS           (1 << 3)
#define OTG_CTRL_OTG_PD_VBUS        (1 << 2)
#define OTG_CTRL_PD_VBUS            (1 << 2)
#define OTG_CTRL_OTG_PU_VBUS        (1 << 1)
#define OTG_CTRL_PU_VBUS            (1 << 1)
#define OTG_CTRL_OTG_PU_ID          (1 << 0)
