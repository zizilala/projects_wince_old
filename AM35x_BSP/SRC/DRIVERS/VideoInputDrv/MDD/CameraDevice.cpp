    ...
    )
{
    ...
    case IOCTL_POWER_SET:
        ...
        if ( pOutBuf && OutBufLen >= sizeof(CEDEVICE_POWER_STATE) )
        {
            ...
            {
            case D0:
                DEBUGMSG(ZONE_IOCTL, (TEXT("CAM: D0\r\n")));
            ...
            case D2:
                DEBUGMSG(ZONE_IOCTL, (TEXT("CAM: D2\r\n")));
            ...
            case D3:
                DEBUGMSG(ZONE_IOCTL, (TEXT("CAM: D3\r\n")));
            ...
            case D4:
                DEBUGMSG(ZONE_IOCTL, (TEXT("CAM: D4\r\n")));
            ...
            default:
                DEBUGMSG(ZONE_IOCTL|ZONE_WARN, (TEXT("CAM: Unrecognized Valid Power state. Powering Up\r\n")));
