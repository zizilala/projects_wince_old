...
if "%IMGMULTIXIP%"=="1" (
    ...
    copy /b AM35x_BSP_multibin_filelist.txt + link_file.txt am35x_multibin_filelist.txt
    cscript multibin_fixup.js am35x_multibin_filelist.txt
    copy multiregion.bib ce.bib
    del link_file.txt
    del am35x_multibin_filelist.txt
    del multiregion.bib
)
