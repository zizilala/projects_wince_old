...
//------------------------------------------------------------------------------
//
//  Function:  OALFlushICacheLines(VOID *pAddress, UINT32 size)
//
//  Invalidate range of addresses in instruction cache.  This routine
...
LEAF_ENTRY(OALFlushICacheLines)
        ...
        // Get cache size
        lw      t0, L1ILineSize(t7)
        
        // Get the last address in range
        addu    t1, a0, a1

        // loop through the cache
10:     cache   HIT_INVALIDATE_I, 0(a0)
        addu    a0, t0
        bltu    a0, t1, 10b
        nop
